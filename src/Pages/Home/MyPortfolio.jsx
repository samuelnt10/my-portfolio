    ...
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        <div className="portfolio--container">
          ...
          <h3 class="skills--section--heading">My Portfolio</h3>
        </div>
        <div>
          <a href="https://github.com/samuelnt10" target="_blank" rel="noopener noreferrer" className="btn btn-github">
            <svg
      ...
      <div className="portfolio--section--container">
        {data?.portfolio?.map((item, index) => (
          <section key={index} className="portfolio--section--card">
            <div className="portfolio--section--img">
              <img src={item.src} alt="Placeholder" />
            </div>
            <div className="portfolio--section--card--content">
              <div>
                <h3 className="portfolio--section--title">Lab {index + 1}</h3>
                <p className="text-md">Click on red button to view}</p>
              </div>
        ...
        <section className="portfolio--section--card">
          <div className="portfolio--section--img">
            <img src={data?.portfolio[2]?.src} alt="Placeholder" />
          </div>
          <div className="portfolio--section--card--content">
            <div>
              <h3 className="portfolio--section--title">Lab 4</h3>
              <p className="text-md">Click on red button to view</p>
            </div>
            <a href={data?.portfolio[2]?.link} className="text-sm portfolio--link">
              {data?.portfolio[2]?.link}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
        ...
        <section className="portfolio--section--card">
          <div className="portfolio--section--img">
            <img src={data?.portfolio[1]?.src} alt="Placeholder" />
          </div>
          <div className="portfolio--section--card--content">
            <div>
              <h3 className="portfolio--section--title">Lab 5</h3>
              <p className="text-md">Click on red button to view</p>
            </div>
            <a href={data?.portfolio[2]?.link} className="text-sm portfolio--link">
              {data?.portfolio[2]?.link}
